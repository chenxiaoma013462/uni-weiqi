...
class Game {
    constructor() {
         ...
         * @type {Number[][]}
         */
        this.arr = new Array(this.width).fill(null).map(() => new Array(this.width).fill(0))
